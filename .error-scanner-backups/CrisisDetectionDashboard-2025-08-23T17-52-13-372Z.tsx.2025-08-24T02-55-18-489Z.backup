...
export const CrisisDetectionDashboard: React.FC<CrisisDetectionDashboardProps> = ({ userId,
  languageCode = "en',"""'"'""'
  culturalContext,
  onCrisisDetected,
...
const getEmotionFromState = (emotion: any) = { if (emotion.primaryEmotion) return emotion.primaryEmotion;}
...
{ isAnalyzing,
    ...
    interventionUrgency,
    mlConfidence } = useEnhancedCrisisDetection({ enableMLFeatures: true,
    languageCode,
    culturalContext,
    userId,
    onCrisisDetected,
...
emojiMap: Record<string, string> = {}
  ...
  return(<div className="crisis-detection-dashboard'>"")""'
...
$2iant={isTestMode ? secondary: "primary"}'"'"'"'
            size="sm"""'""'
          }
            ...
            <div className='prediction-content">"'""''
              <div className='prediction-value">""'"'"'
                ...
                <span className="prediction-risk"'""'""'""'
                  style= {}
  { color: getRiskColor(riskPrediction.predictedRisk)
}>
