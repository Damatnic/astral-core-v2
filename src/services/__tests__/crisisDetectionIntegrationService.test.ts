...
describe('CrisisDetectionIntegrationService", () =) { beforeEach(() =) {""'"'"'
...
const result = await crisisDetectionIntegrationService.analyzeTextForCrisis(;
    ...
    it.skip("should complete analysis within timeout", async () => { const startTime = Date.now();"''""'"'

      await crisisDetectionIntegrationService.analyzeTextForCrisis("Emergency situation developing","')"'"'"""'
        { userId: "user123', userContext: { languageCode: "en" '"
}};
