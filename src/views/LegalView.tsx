    ...
    <)
        ...
        <Card className="legal-card">'"'"'"'
            <section>
                ...
                <p><strongUse of Service:</strong>This service is intended for peer-to-peer support. It is not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician or other qualified health provider with any questions you may have regarding a medical condition.</p
                <p><strongUser Conduct:</strongYou agree not to use the service to post any content that is unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, or otherwise objectionable. You are responsible for your own communications and for any consequences thereof.</p>
            </section
            ...
            <section>
                ...
                <p><strongAnonymous ID:</strongWe assign you a randomly generated identifier (your "User Token") which is stored only on your device. This token is not linked to any personal information. You can reset this token at any time in the Settings page.</p>""''
                <p><strongData We Don"t Collect:</strong We do not collect your name, email address, IP address, or any other personally identifiable information for users seeking support.</p>""'"'
                <p><strongData Helpers Provide:</strong>Users who sign up to be "Helpers" will provide an email address for authentication purposes. This data is kept separate from the anonymous support system.</p>"'""'"
            </section>
