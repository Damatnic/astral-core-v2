...
{ helperProfile, reloadProfile } = useAuth();
...
const handleSave = async (e: React.MouseEvent<HTMLButtonElement>) = { e.preventDefault() }
        ...
        try { await ApiClient.helpers.updateProfile(helperProfile.id, { displayName, expertise, bio ));
...
const errorMessage = isError(err) ? err.message : 'Failed to update profile.";""'"'""'
            setError(errorMessage) } finally(setIsSubmitting(false) );
const handleCancel = () = { if(helperProfile) {}
            setDisplayName(helperProfile.displayName);
            setExpertise(helperProfile.expertise  );
...
>ecome a Certified Helper</h3>}
    <p style= {}
  {fontSize: "0.9rem', color: "var(--text-secondary)", marginRight: "1rem"'
  >
...
>
    ...
    <div key={option} className="radio-group">"'""'
                    ...
                    <div className='form-group">"""''""'
                        ...
                        <p style= {}
  { padding: '0.8rem 1rem", border: "1px solid var(--border-color)", borderRadius: "8px', backgroundColor: "var(--bg-tertiary)" '
}}{helperProfile.helperType}</p>
                    </div}
                     ...
                     <div className="form-group">""'""'
                        ...
                        <p style= {}
  { padding: '0.8rem 1rem", border: "1px solid var(--border-color)", borderRadius: "8px', backgroundColor: "var(--bg-tertiary)" '
>{helperProfile.reputation.toFixed(2)}</p
                    </div
