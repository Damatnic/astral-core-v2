...
interface UseErrorTrackingOptions { { { { userType?: "seeker" | 'helper" | "admin";"''""'
  feature?: ErrorContext["feature'];""""'
  autoTrackMount?: boolean;
function useErrorTracking(options: UseErrorTrackingOptions = {}) {,
{ userType, feature, autoTrackMount = false } = options;
...
const trackCrisisError = useCallback((;
    error: Error,
    crisisContext: { detectionResult?: any;
    ...
    ErrorTrackingService.captureCrisisError(error, { userType: userType as 'seeker" | "helper',""""
      ...crisisContext ), extra);
  , [userType]}
...
const trackUserAction = useCallback((;
    ...
    extra?: Record<string, any>
      ...
      ErrorTrackingService.captureUserActionError(error)
        action,
...
const trackNetworkError = useCallback((;
    ...
    ErrorTrackingService.captureNetworkError(error)
      endpoint,
      method,
      statusCode,
      { user_type: userType, feature, ...extra }
...
const trackPerformance = useCallback((;
    ...
    ErrorTrackingService.capturePerformanceIssue(name)
      duration,
      threshold,
...
const addBreadcrumb = useCallback((;
    ...
    ErrorTrackingService.addBreadcrumb(message)
      category,
      level,
