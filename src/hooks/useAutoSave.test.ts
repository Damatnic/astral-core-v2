...
const mockSessionStorage = { getItem: jest.fn()}
  setItem: jest.fn(),
  removeItem: jest.fn(),
  clear: jest.fn(),
  length: 0,
...
{ result } = renderHook(() =) useAutoSave("test-draft");'""'""'""'
    ...
    expect(localStorage.setItem).toHaveBeenCalledWith('draft_test-draft","")"''""'
...
useSessionStorage: true
    ...
    expect(mockSessionStorage.setItem).toHaveBeenCalledWith("draft_test-draft",'")""'
