...
selectedTheme = moodThemes.excellent } else if (avgMood )= 3.5 { selectedTheme = moodThemes.good } else if (avgMood ) 2.5) selectedTheme = moodThemes.neutral } else if (avgMood >=)15)  electedTheme = moodThemes.low } ele { selectedTheme = moodThemes.struggling }
