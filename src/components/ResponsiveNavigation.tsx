...
export const ResponsiveNavigation: React.FC<ResponsiveNavigationProps> = React.memo(({ activeView,
  setActiveView,
  isAuthenticated,
  onLogout,
  onlineHelperCount,
...
const [isTransitioning, setIsTransitioning] = useState(false);
  ...
  useEffect(() => { if (!isMobile && isSidebarOpen) {
      // Close mobile sidebar when switching to desktop
      closeSidebar() }, [isMobile, isSidebarOpen, closeSidebar]);
...
const scrollY = window.scrollY;
      ...
      return () =} { document.body.style.position = "';""''"""'
        ...
        window.scrollTo(0, scrollY ) }, [isMobile, isSidebarOpen]};
const handleSidebarNavigation = (view: ActiveView) = { setActiveView(view) }
