...
export const CommunityWellnessIndicator: React.FC<CommunityWellnessIndicatorProps> = ({ activeUsers,
  supportGiven,
  postsToday,
  overallMood }) = {;}
const getMoodColor = () =} {
...
default: return 'Welcome to our supportive community""'""
  ...
  return(<div className='community-wellness-card">")''""""'
      <div className='wellness-header">"'""""
        <h3 className='wellness-title">"'""""
          <SparkleIcon className='wellness-icon"     />"''"""'
          Community Wellness
        </h3)
        <div className="wellness-mood' style= {")"'"}
