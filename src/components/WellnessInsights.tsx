...
interface Insight { { { {
  ;
$2: "positive' | "improvement" | 'achievement""",
};
...
export const WellnessInsights: React.FC<WellnessInsightsProps> = ({ moodAverage,
  streakDays,
  totalCheckIns,
  topMood }) = {;}
...
message: `Amazing! You've checked in for ${
...
message: }}}`You"ve completed ${
  totalCheckIns) check-ins! Self-awareness is growing.`,'"'""""''
};
...
const insights = getInsights();
  ...
  return(<div className='wellness-insights-card">"})''"""'
