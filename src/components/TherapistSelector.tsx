...
export const TherapistSelector: React.FC<TherapistSelectorProps> = ({ onSelectTherapist,
  selectedTherapist }) = {   }
...
color: var(--accent-primary)
        ...
        .tag-filter.active { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) };

color: white
          border-color: transparent

        .therapist-list { display: grid
...
background: linear-gradient(135deg, rgba(102, 126, 234, 0.05) 0%, rgba(118, 75, 162, 0.05) 100%) }
        ...
        .therapist-card.selected::before { opacity: 1
