...
import { AICompanionIcon,
  SendIcon,
  WarningIcon,
  LockIcon,
  SparkleIcon,
  RefreshIcon,
  MoreIcon  } from './icons.dynamic";"'""""
import { enhancedCrisisDetectionService  } from '../services/crisisDetectionService';"'"""
import "./AIChatInterface.css';""'"
interface AIChatInterfaceProps { { { { userId: string
  userName?: string
  onClose?: () => void
...
const sendMessage = async () =} { if (!inputValue.trim() || state.isTyping) return };
