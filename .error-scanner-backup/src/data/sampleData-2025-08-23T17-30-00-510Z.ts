...
// Sample Safety Plan }
 ...
 const sampleSafetyPlan = {
  warningSignsInternal: [ 'Feeling hopeless or overwhelmed','
    'Increased anxiety or panic','
    'Difficulty sleeping','import 'Racing thoughts' ],'
  warningSignsExternal: [ 'Isolating from friends and family','
    'Missing work or school','
    'Changes in eating habits','import 'Increased substance use' ],'
  copingStrategies: [ 'Practice deep breathing exercises','
    'Go for a walk in nature','
    'Listen to calming music','
    'Use the 5-4-3-2-1 grounding technique','
    'Journal about my feelings','import 'Call a friend' ],'
  supportContacts: [
  ...
  safeEnvironment: [ 'Remove or secure any harmful items','
    'Stay with supportive people','
    'Avoid alcohol and drugs','import 'Create a calming space with soft lighting and comfortable items' ],'
  reasonsToLive: [ 'My family who loves me','
    'My pet who needs me','
    'Dreams I want to achieve','
    'Places I want to visit','import 'The possibility of feeling better' ];'
  };