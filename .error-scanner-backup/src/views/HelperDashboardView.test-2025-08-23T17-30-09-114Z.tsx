...
jest.mock('../components/XPBar', () => ({ XPBar: () => <div>XPBar Mock</div>}));'
...
const startChatMock = jest.fn();
  ...
  beforeEach(() => { jest.clearAllMocks();
    ...
    mockedDilemmaStore.mockReturnValue({ allDilemmas: mockDilemmas,
      acceptDilemma: acceptDilemmaMock});

    mockedChatStore.mockReturnValue({ startChat: startChatMock});
