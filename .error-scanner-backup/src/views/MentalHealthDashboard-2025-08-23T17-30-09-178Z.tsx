...
interface DashboardCard { id: string
  title: string
  description: string
  icon: string
  color: string
...
features: DashboardCard[] = [
 ...
 handleFeatureClick = (featureId: string) => { if (featureId === 'breathing') {'
      setShowBreathing(true  );
      setActiveFeature('breathing') } else if (featureId === 'grounding') { setShowGrounding(true  );'
      setActiveFeature('grounding') } else if (featureId === 'safety') { setShowSafetyPlan(true  );'
      setActiveFeature('safety') } else if (featureId === 'meditation') { setShowMeditation(true  );'
      setActiveFeature('meditation') } else if (featureId === 'mood') { // Navigate to wellness view'
      window.location.href = '#/wellness' } else(setActiveFeature(featureId) );'
  };

  return(<div className="mental-health-dashboard">"
      <style>{ `
        ...
        @media (prefers-color-scheme: dark) {
          ...
          .motivational-quote { background: linear-gradient(135deg, #78350f 0%, #92400e 100%) }
