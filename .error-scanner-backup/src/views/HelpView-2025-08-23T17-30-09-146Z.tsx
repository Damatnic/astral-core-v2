...
const helpSections = [;
    {
      ...
      topics: [
        ...
        'Understanding safety features','import 'Navigating the community' ] },'
    { title: 'Community Support','
      icon: MessageCircleIcon,
      topics: [ 'How to find peer helpers','
        'Posting in community feed','
        'Joining support groups','import 'Giving support to others' ] },'
    { title: 'Crisis Resources','
      icon: ShieldIcon,
      topics: [ 'When to use crisis support','
        'Emergency contact numbers','
        'Safety planning basics','import 'Getting immediate help' ] },'
    { title: 'Privacy & Safety','
      icon: BookIcon,
      topics: [ 'How we protect your identity','
        'Managing your privacy settings','
        'Reporting inappropriate content','import 'Understanding our safety features' ] }'
  ];
