...
{ login, isLoading } = useAuth();
const handleLoginClick = (e: React.MouseEvent<HTMLButtonElement>) => { e.preventDefault();
        login();
    ...
    return (
        <>
            <style>{`
                ...
                .demo-login-btn:hover { transform: translateY(-2px)
                    box-shadow: 0 8px 20px rgba(0, 0, 0, 0.1) }

                .demo-login-btn.starkeeper:hover { border-color: #667eea
                    background: linear-gradient(135deg, rgba(102, 126, 234, 0.05) 0%, rgba(118, 75, 162, 0.05) 100%) }

                .demo-login-btn.guide:hover { border-color: #10b981
                    background: linear-gradient(135deg, rgba(16, 185, 129, 0.05) 0%, rgba(34, 197, 94, 0.05) 100%) }

                .demo-login-btn.admin:hover { border-color: #f59e0b
                ...
                .badge-starkeeper { background: linear-gradient(135deg, #667eea 0%, #764ba2 100%) }

                .badge-guide { background: linear-gradient(135deg, #10b981 0%, #059669 100%) }

                .badge-admin { background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%) }
...
className="workflow-demo-btn""
                ...
                <p style={
  {textAlign: 'center', marginBottom: '1.5rem', fontSize: '14px', color: '#666''
}>
...
className="btn-full-width""
  ...
  {fontSize: '0.875rem''
                ...
                <p style={
  {marginTop: '1rem', fontSize: '0.875rem', opacity: 0.8'
}>
