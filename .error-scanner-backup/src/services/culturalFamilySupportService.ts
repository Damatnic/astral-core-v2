  ...
  private initializeCulturalGuidance(): void { this.culturalGuidance = {
      'Western': {
        ...
        communicationTemplates: { 'mild_concern': {
          ...
          'crisis_alert': { subject: 'Urgent: Support Needed',
      ...
      'Hispanic/Latino': { region: 'Hispanic/Latino',
        familyInvolvementGuidelines: {
        ...
        crisisManagement: { escalationApproach: 'Gradual involvement starting with family, then community supports',
      ...
      'Arabic': { region: 'Arabic',
        ...
        crisisManagement: { escalationApproach: 'Authority-based through family hierarchy and religious guidance',
      ...
      'Chinese': { region: 'Chinese',
        ...
        crisisManagement: { escalationApproach: 'Gradual approach through family hierarchy',
...
decisionMakingProcess: FamilySupport['communicationGuidelines']['decisionMakingProcess'] = 'individual'
    if (culturalContext.familyInvolvement === 'family-centered') {
      ...
      decisionMakingProcess = 'family_consensus' } else if (culturalContext.familyInvolvement === 'community-based') { familyMeetingFormat = 'elder_mediated';
