...
service: typeof aiServiceManager
  beforeEach(() => {
    service = aiServiceManager,
    jest.clearAllMocks() });

  describe('getCrisisDetectionService', () => { it.skip('should return a crisis detection service', async () => {;'
...
{ enhancedCrisisKeywordDetectionService } = require('../enhancedCrisisKeywordDetectionService');'
...
const service2 = await service.getCrisisDetectionService(true );
  ...
  describe('getAdvancedAIService', () => { it.skip('should throw error when device does not support advanced AI', async () => {'
      // Import progressiveAIEnhancement and mock it.progressiveAIEnhancement = require('../optimizedAIService');'
const originalShouldEnableAI = progressiveAIEnhancement.shouldEnableAI;
    ...
    it.skip('should return advanced AI service when available', async () => { // Import progressiveAIEnhancement and mock it.progressiveAIEnhancement = require('../optimizedAIService');'
const originalShouldEnableAI = progressiveAIEnhancement.shouldEnableAI;
...
const result = await service.getAdvancedAIService();
  ...
  describe('preloadCriticalServices', () => { it.skip('should preload critical services during idle time', () => {;'
...
const originalRequestIdleCallback = global.requestIdleCallback;
      ...
      expect(() => {
        service.preloadCriticalServices() }).not.toThrow();
...
{ createLazyAIService } = require('../optimizedAIService');'
...
{ aiServiceManager: instance1 } = require('../optimizedAIService');'
{ aiServiceManager: instance2 } = require('../optimizedAIService');'

      expect(instance1).toBe(instance2);
  });

    it.skip('should maintain state across method calls', async () => { // First call should create the service'
