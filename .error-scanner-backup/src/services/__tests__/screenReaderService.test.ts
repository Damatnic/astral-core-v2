...
originalAppendChild: typeof document.body.appendChild
originalGetElementById: typeof document.getElementById
...
appendChildSpy: jest.SpyInstance
  ...
  afterEach(() => { // Restore original methods
...
const liveRegions = document.querySelectorAll('[aria-live]' );
  ...
  describe('initialization', () => { it.skip('should initialize ARIA live regions', async () => {
    ...
    it.skip('should complete initialization', async () => { await service.initialize();
      // Initialization should complete without errors
      expect(true).toBe(true) });
  });

  describe('announcements', () => { beforeEach(async () => {
      await service.initialize() });
...
const history = service.getAnnouncementHistory();
    ...
    it.skip('should clear announcement history', () => { service.clearAnnouncementHistory();
const history = service.getAnnouncementHistory();
...
const context = service.getCrisisContext();
  ...
  describe('cleanup', () => { it.skip('should destroy service properly', () => {
      service.destroy();
