...
interface CopingStrategy { id: string
  name: string
  description: string
...
$2: 'peer',
      ...
      communicationGuidelines: [ { context: 'Discussing mental health',
    ...
    this.contentCache.set('es', {
      ...
      crisisApproaches: [ { id: 'es-crisis-family',
...
$2: 'community',
      ...
      communicationGuidelines: [ { context: 'Hablar de salud mental',
...
$2: 'professional',
      ...
      communicationGuidelines: [ { context: 'Discutir saúde mental',
...
$2: 'family',
      ...
      communicationGuidelines: [ { context: 'التحدث عن الصحة النفسية',
...
$2: 'professional',
      ...
      communicationGuidelines: [ { context: '讨论心理健康',
    ...
    this.contentCache.set('vi', {
      ...
      copingStrategies: [ { id: 'vi-meditation',
...
$2: 'religious',
      ...
      communicationGuidelines: [ { context: 'Nói về sức khỏe tâm thần',
    ...
    this.contentCache.set('tl', {
      ...
      copingStrategies: [ { id: 'tl-bayanihan',
...
$2: 'community',
      ...
      communicationGuidelines: [ { context: 'Pag-usap tungkol sa mental health',
