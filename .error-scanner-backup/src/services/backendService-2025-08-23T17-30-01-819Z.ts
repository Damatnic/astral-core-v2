...
return await response.json();
  } catch (error) { logger.error('API Call Failed:', error, 'backendService' );'
    throw error  };
...
export const userService = {
  ...
  async getProfile() { return apiCall('/users/profile') },'

  async updateProfile(data: unknown) { return apiCall('/users/profile', 'PUT', data) };'
  };

// Mood Tracking
export const moodService = { async saveMoodEntry(moodData: {
    mood: string
    score: number
    notes?: string
    triggers?: string[]
    activities?: string[] }) { return apiCall('/mood', 'POST', moodData) },'

  async getMoodHistory() { return apiCall('/mood') },'
...
export const assessmentService = {
  ...
  async getAssessmentHistory() { return apiCall('/assessments') },'
...
// Safety Planning
export const safetyPlanService = { async getSafetyPlan() {
...
// Journal/Reflections
export const journalService = { async saveEntry(entry: {
    title: string
    content: string
    mood?: string
    tags?: string[] }) { return apiCall('/journal', 'POST', entry) },'
...
// Crisis Resources
export const crisisService = { async getResources() {
  ...
  async getEmergencyContacts() { return apiCall('/crisis/emergency-contacts') };'
  };

// Peer Support
export const peerSupportService = { async findMatch(preferences: any) {
  ...
  async getConversations() { return apiCall('/peer-support/conversations') },'
...
// Health Check
export const healthService = { async checkHealth() {
