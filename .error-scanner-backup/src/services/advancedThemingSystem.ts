...
interface TherapeuticThemeConfig {
  id: TherapeuticTheme
  name: string
  description: string
...
interface ThemeContextValue { // Current theme state
...
Theme: (themeData: string) => boolean
...
// Default calm sanctuary theme for mental health support;
 ...
 defaultCalmTheme: ThemeColors={ primary: "#2E7D8F",
  primaryLight: "#4A9FB0",
  primaryDark: "#1F5A6A",
  secondary: "#7FB069",
...
defaultCalmThemeDark: ThemeColors={ primary: "#4A9FB0",
  primaryLight: "#6BB5C5",
  primaryDark: "#2E7D8F",
  secondary: "#A4C989",
  ...
  const crisisSafeThemeLight: ThemeColors = { primary: "#C53030",
  primaryLight: "#E53E3E",
  primaryDark: "#9B2C2C",
  secondary: "#2B6CB0",
...
crisisSafeThemeDark: ThemeColors={ primary: "#FC8181",
  primaryLight: "#FEB2B2",
  primaryDark: "#E53E3E",
  secondary: "#63B3ED",
...
export const useTheme = (): void => { const context = React.useContext(ThemeContext );
  if(!context) {
