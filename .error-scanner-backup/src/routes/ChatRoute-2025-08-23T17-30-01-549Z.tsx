...
const handleViewHelperProfile = (helperId: string) => { console.log('Viewing helper profile:', helperId  );'
    // Handle navigation to helper profile
    // In a real implementation, this would navigate to /helper/profile/${helperId}
  );

  if (!session || !dilemma) {
    return <div>Loading chat...</$1>}
