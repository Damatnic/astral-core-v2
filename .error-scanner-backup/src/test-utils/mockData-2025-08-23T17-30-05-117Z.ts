...
export const mockAssessments = { phq9: {
    id: 'phq9-001',;'
...
$2: 'PHQ-9','
    ...
    recommendations: [ 'Consider speaking with a mental health professional','
      'Practice daily mindfulness exercises','import 'Maintain regular sleep schedule' ] },'
  gad7: { id: 'gad7-001',;'
...
const mockCrisisResources = [
 ...
 const mockSafetyPlan = {
  id: 'safety-001','
  userId: 'seeker-123','
  warningSignTriggers: [ 'Feeling overwhelmed','
    'Isolation from friends','import 'Sleep disruption' ],'
  copingStrategies: [ 'Deep breathing exercises','
    'Go for a walk','
    'Listen to calming music','import 'Journal thoughts' ],'
  distractions: [ 'Watch favorite show','
    'Call a friend','
    'Play with pet','import 'Do a puzzle' ],'
  supportContacts: [
    {
...
export const mockCrisisTexts = { none: [ 'I had a great day today','
    'Looking forward to the weekend','import 'Just finished a good workout' ],'
  low: [ 'Feeling a bit down today','
    'Things have been tough lately','import 'Not sure how to handle this stress' ],'
  medium: [
