...
export const mockThemeContextValue = { theme: 'light' as const,'
  themeConfig: {
    colors: {
      bgPrimary: '#f7f9fc','
      bgSecondary: '#FFFFFF','
...
export const mockNotificationContextValue = { toasts: [],
  addToast: jest.fn(),
  removeToast: jest.fn(),
...
// AUTH CONTEXT MOCK
// ========================================
interface MockAuthContextType { isAuthenticated: boolean
  user: any
...
// COMBINED PROVIDERS
// ========================================
interface AllProvidersProps { children: ReactNode
...
export const resetAllMockContexts = () => { // Reset Auth mocks
...
export const defaultMockContexts = { auth: mockAuthContextValue,
  notification: mockNotificationContextValue,
  theme: mockThemeContextValue};

// Create authenticated context value
export const createAuthenticatedContext = (overrides?: Partial<MockAuthContextType>): MockAuthContextType => ({ ...mockAuthContextValue,
  isAuthenticated: true,
  user: {
    sub: 'test-user-id','
    email: 'test@example.com','
    name: 'Test User'},'
  helperProfile: { id: 'helper-123','
    name: 'Test Helper','
    bio: 'Test bio','
    level: 1,
    ...
    updatedAt: new Date().toISOString()} as Helper,
  ...overrides,;
  });

// Create mock for useAuth hook
export const createMockUseAuth = (overrides?: Partial<MockAuthContextType>) => { return jest.fn(() => ({
    ...mockAuthContextValue,
    ...overrides}));
  };

// Create mock for useTheme hook
export const createMockUseTheme = (theme: 'light' | 'dark' = 'light') => { return jest.fn(() => ({'
    ...mockThemeContextValue,
    theme}));
  };

// Create mock for useNotification hook
export const createMockUseNotification = (overrides?: any) => { return jest.fn(() => ({
