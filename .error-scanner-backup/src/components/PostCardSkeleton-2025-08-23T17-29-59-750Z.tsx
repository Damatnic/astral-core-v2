...
interface PostCardSkeletonProps { /** Number of skeleton cards to render */
  count?: number;
  /** Show additional skeleton elements for helper view */
  isHelperView?: boolean,
  /** Animate the skeleton */
  animate?: boolean };
export const PostCardSkeleton: React.FC<PostCardSkeletonProps> = ({ count = 1,
  isHelperView = false,
  animate = true }) => {
  return (
    <>
