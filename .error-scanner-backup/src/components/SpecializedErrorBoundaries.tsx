...
// Fallback components
const CommunicationFallback: React.FC<ErrorFallbackProps> = ({ resetErrorBoundary, 
  retryCount, 
  config }) => (
...
const FormFallback: React.FC<ErrorFallbackProps> = ({ error, 
  resetErrorBoundary }) => (
...
const DashboardFallback: React.FC<ErrorFallbackProps> = ({ resetErrorBoundary }) => (
...
const AdminFallback: React.FC<ErrorFallbackProps> = ({ error, 
  resetErrorBoundary }) => (
...
const PageFallback: React.FC<ErrorFallbackProps & { pageName?: string }> = ({ resetErrorBoundary,
  pageName = 'page' }) => (
...
const NetworkFallback: React.FC<ErrorFallbackProps & { isOnline: boolean }> = ({ resetErrorBoundary, 
  retryCount, 
  config,
  isOnline }) => (
 ...
 DevFallback: React.FC<ErrorFallbackProps> = ({ error, 
  errorInfo, 
  resetErrorBoundary }) => (
...
export const NetworkErrorBoundary: React.FC<{ children: React.ReactNode }> = ({ children }) => { const [isOnline, setIsOnline] = React.useState(navigator.onLine);
...
export const SpecializedErrorBoundariesBundle = { CrisisErrorBoundary,
  AuthErrorBoundary,
