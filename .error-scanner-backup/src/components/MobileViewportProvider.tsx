...
export const MobileForm: React.FC<MobileFormProps> = ({ children,
  onSubmit,;
...
MobileInputProps extends React.InputHTMLAttributes<HTMLInputElement> { label?: string;
  ...
  helpText?: string };
export const MobileInput: React.FC<MobileInputProps> = ({ label,
  error,
  floatingLabel = false,
  helpText,;
 ...
 */;
interface MobileModalProps { isOpen: boolean
  onClose: () => void
  title?: string
