...
interface LazyMarkdownProps { children: string
$2Name?: string
...
export const LazyMarkdown: React.FC<LazyMarkdownProps> = ({ children,;
...
const handleLoadMarkdown = () => { setIsLoading(true ),
    setShouldLoad(true) };
...
return (
  ...
  { __html: renderSimpleMarkdown(children)
  } />
        </$1>}
    >
...
const MarkdownRenderer: React.FC<{ children: string, className: string }> = ({ children,,
