...
import { getConnectionType,
  ...
  ConnectionType,
  NetworkQuality,
  AdaptiveLoadingConfig, } from './networkDetection';
...
mockUseState: jest.MockedFunction<typeof React.useState> | undefined
mockUseEffect: jest.MockedFunction<typeof React.useEffect> | undefined
describe('networkDetection', () => { beforeEach(() => {
    jest.clearAllMocks();
  ...
  describe('getConnectionType', () => { it('should return 2g for slow-2g effective type', () => {
      mockConnection.effectiveType = 'slow-2g';
const result = getConnectionType();
      
      expect(result).toBe('2g') });

    it('should return 2g for 2g effective type', () => { mockConnection.effectiveType = '2g';
const result = getConnectionType();
      
      expect(result).toBe('2g') });

    it('should return 3g for 3g effective type', () => { mockConnection.effectiveType = '3g';
const result = getConnectionType();
      
      expect(result).toBe('3g') });

    it('should return 4g for 4g effective type', () => { mockConnection.effectiveType = '4g';
const result = getConnectionType();
      
      expect(result).toBe('4g') });

    it('should default to 4g for unknown effective type', () => { mockConnection.effectiveType = 'unknown';
const result = getConnectionType();
      
      expect(result).toBe('4g') });

    it('should return unknown when navigator.connection is unavailable', () => { Object.defineProperty(navigator, 'connection', {
        value: undefined,
        writable: true, });
const result = getConnectionType();
...
const connectionWithoutEffectiveType = { ...mockConnection };
      ...
      Object.defineProperty(navigator, 'connection', { value: connectionWithoutEffectiveType,
        writable: true, });
const result = getConnectionType();
      
      expect(result).toBe('4g'); // Should default to 4g));

  describe('getNetworkQuality', () => { it('should return poor for low downlink speed', () => {
...
const result = getNetworkQuality();
    ...
    it('should return poor for high RTT', () => { mockConnection.downlink = 1;
      mockConnection.rtt = 600;
const result = getNetworkQuality();
      
      expect(result).toBe('poor') });

    it('should return excellent for high speed and low latency', () => { mockConnection.downlink = 5;
      mockConnection.rtt = 100;
const result = getNetworkQuality();
      
      expect(result).toBe('excellent') });

    it('should return good for moderate conditions', () => { mockConnection.downlink = 1.5;
      mockConnection.rtt = 200;
const result = getNetworkQuality();
      
      expect(result).toBe('good') });

    it('should default to good when navigator.connection is unavailable', () => { Object.defineProperty(navigator, 'connection', {
        value: undefined,
        writable: true, });
const result = getNetworkQuality();
...
const connectionWithoutProperties = {};
      Object.defineProperty(navigator, 'connection', { value: connectionWithoutProperties,
        writable: true, });
const result = getNetworkQuality();
      
      expect(result).toBe('good'); // Uses default downlink=1, rtt=300)
    it('should handle edge case values correctly', () => { // Test boundary conditions based on implementation:
 ...
 testCases = [
      ...
      testCases.forEach(({ downlink, rtt, expected }) => { mockConnection.downlink = downlink;
...
const result = getNetworkQuality();
  ...
  describe('getAdaptiveLoadingConfig', () => { beforeEach(() => {
...
const result = getAdaptiveLoadingConfig();
    ...
    it('should recommend optimal settings for excellent connection', () => { mockConnection.effectiveType = '4g';
...
const result = getAdaptiveLoadingConfig();
    ...
    it('should recommend conservative settings for poor connection', () => { mockConnection.effectiveType = '2g';
      mockConnection.downlink = 0.3;
      mockConnection.rtt = 600;
const result = getAdaptiveLoadingConfig();
    ...
    it('should disable preloading when saveData is enabled', () => { mockConnection.effectiveType = '4g';
      mockConnection.downlink = 5;
      mockConnection.rtt = 100;
...
const result = getAdaptiveLoadingConfig();
    ...
    it('should not preload videos on 2g even with good quality', () => { mockConnection.effectiveType = '2g';
...
const result = getAdaptiveLoadingConfig();
    ...
    it('should handle missing connection gracefully', () => { Object.defineProperty(navigator, 'connection', {
        value: undefined,
        writable: true, });
const result = getAdaptiveLoadingConfig();
      
      expect(result).toEqual({ connectionType: 'unknown',
        quality: 'good',
        downlink: 1,
        rtt: 300,
        saveData: false,
...
const partialConnection = {
      ...
      Object.defineProperty(navigator, 'connection', { value: partialConnection,
        writable: true, });
const result = getAdaptiveLoadingConfig();
...
mockConfig: AdaptiveLoadingConfig
    beforeEach(() => {
      mockConfig = {
        connectionType: '4g',
        quality: 'good',
    ...
    describe('auto-play feature', () => { it('should enable auto-play for good quality without data saver', () => {;
const result = shouldEnableFeature('auto-play', mockConfig );
        expect(result).toBe(true) });

      it('should disable auto-play for poor quality', () => { mockConfig.quality = 'poor';
const result = shouldEnableFeature('auto-play', mockConfig );
        expect(result).toBe(false) });

      it('should disable auto-play when data saver is enabled', () => { mockConfig.saveData = true;
const result = shouldEnableFeature('auto-play', mockConfig );
        expect(result).toBe(false) });
  });

    describe('high-res-images feature', () => { it('should enable for high image quality setting', () => {
        mockConfig.recommendedImageQuality = 'high';
const result = shouldEnableFeature('high-res-images', mockConfig );
        expect(result).toBe(true) });

      it('should disable for medium image quality setting', () => { mockConfig.recommendedImageQuality = 'medium';
const result = shouldEnableFeature('high-res-images', mockConfig );
        expect(result).toBe(false) });

      it('should disable for low image quality setting', () => { mockConfig.recommendedImageQuality = 'low';
const result = shouldEnableFeature('high-res-images', mockConfig );
        expect(result).toBe(false) });
  });

    describe('video-preload feature', () => { it('should enable when shouldPreloadVideos is true', () => {
        mockConfig.shouldPreloadVideos = true;
const result = shouldEnableFeature('video-preload', mockConfig );
        expect(result).toBe(true) });

      it('should disable when shouldPreloadVideos is false', () => { mockConfig.shouldPreloadVideos = false;
const result = shouldEnableFeature('video-preload', mockConfig );
        expect(result).toBe(false) });
  });

    describe('background-sync feature', () => { it('should enable for good quality connection', () => {
        mockConfig.quality = 'good';
const result = shouldEnableFeature('background-sync', mockConfig );
        expect(result).toBe(true) });

      it('should enable for excellent quality connection', () => { mockConfig.quality = 'excellent';
const result = shouldEnableFeature('background-sync', mockConfig );
        expect(result).toBe(true) });

      it('should disable for poor quality connection', () => { mockConfig.quality = 'poor';
const result = shouldEnableFeature('background-sync', mockConfig );
        expect(result).toBe(false) });
  });
...
const result = shouldEnableFeature('unknown-feature' as any, mockConfig );
    ...
    it('should use current config when none provided', () => { // Test that it calls getAdaptiveLoadingConfig internally
...
const result = shouldEnableFeature('auto-play', undefined as any );
  ...
  describe('logNetworkInfo', () => { it('should log comprehensive network information', () => {
      logNetworkInfo();
  ...
  describe('type definitions', () => { it('should accept valid ConnectionType values', () => {;
validTypes: ConnectionType[] = ['2g', '3g', '4g', '5g', 'wifi', 'unknown'];
      validTypes.forEach(type => {
        expect(['2g', '3g', '4g', '5g', 'wifi', 'unknown']).toContain(type) });
  });

    it('should accept valid NetworkQuality values', () => {;
validQualities: NetworkQuality[] = ['poor', 'good', 'excellent'];
...
config: AdaptiveLoadingConfig = {
  ...
  describe('edge cases and error handling', () => { it('should handle connection object with null values', () => {;
const connectionWithNulls = {
      ...
      Object.defineProperty(navigator, 'connection', { value: connectionWithNulls,
        writable: true, });
      
      expect(() => { getConnectionType();
        getNetworkQuality();
        getAdaptiveLoadingConfig() }).not.toThrow();
  });

    it('should handle negative network values', () => { mockConnection.downlink = -1;
      mockConnection.rtt = -100;
...
const config = getAdaptiveLoadingConfig();
    ...
    it('should handle extremely high network values', () => { mockConnection.downlink = 1000; // 1 Gbps
...
const config = getAdaptiveLoadingConfig();
    ...
    it('should handle connection type case sensitivity', () => { mockConnection.effectiveType = '4G'; // Uppercase
const connectionType = getConnectionType();
      
      expect(connectionType).toBe('4g'); // Should default to 4g for unknown)
    it('should handle string numbers in connection properties', () => { (mockConnection as any).downlink = '2.5';
      (mockConnection as any).rtt = '150';
      
      expect(() => {;
const quality = getNetworkQuality();
        expect(['poor', 'good', 'excellent']).toContain(quality) }).not.toThrow();
  });
  });

  describe('performance considerations', () => { it('should be performant for repeated calls', () => {;
...
const timePerCall = (end - start) / iterations;
    ...
    it('should not create memory leaks with repeated hook usage', () => { // Simulate multiple hook instances
      for (let i = 0; i < 100; i++) {
