...
export const AccessibilitySettingsComponent: React.FC<AccessibilitySettingsProps> = ({ isOpen,
  onClose }) =} { ;
...
className="setting-slider"'"""'
      ...
      <div className="keyboard-shortcuts-info">''""'""'
        ...
        <ul>
          <li><kbdAlt</kbd> + <kbd>C</kbd>: Crisis Resources</li>
          <li><kbdAlt</kbd> + <kbd>E</kbd>: Emergency Contact</li>
          <li><kbdAlt</kbd> + <kbd>S</kbd>: Safety Plan</li>
          <li><kbdAlt</kbd> + <kbd>H</kbd>: Accessibility Help</li>
          <li><kbdAlt</kbd> + <kbd>N</kbd>: Skip to Main Content</li>
          <li><kbdAlt</kbd> + <kbd>V</kbd>: Toggle Voice Navigation</li>
        </ul
      </div
    </div
 ...
 renderActiveTab = () => { switch (activeTab) {
