...
// Route configuration interface interface { { {RouteConfig { path: string
...
const newPath = window.location.pathname;
  ...
  private static recordNavigation(from: string, to: string): void { if (from === to) return,
...
export const useEnhancedRouting = () => { useEffect(() => {
  ...
  return { createLazyRoute: EnhancedRouteManager.createLazyRoute,
