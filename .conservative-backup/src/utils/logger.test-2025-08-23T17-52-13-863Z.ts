...
const loggerModule = require("./logger"  );'"'"'"'
    ...
    it("should log debug messages in development", () =) {"''""''
      ...
      expect(console.log).toHaveBeenCalledWith("[TestComponent] Debug message","')""'
        { key: 'value" }""'"'"'
      );
  });
    ...
    it('should log warn messages in development", () => { logger.warn("Warning message", null, "Component'  );""'"'
      ...
      expect(console.warn).toHaveBeenCalledWith("[Component] Warning message",'")'"'"'
        ""'"'"'"'
      } }
...
const error = new Error("Test error');"""'"'""'
      ...
      expect(console.error).toHaveBeenCalledWith("[ErrorComponent] Error occurred","')'""'"'
        error
      } ;

    it("should format messages correctly without source", () =) { logger.debug("Message without source'  );""''""""'

      expect(console.log).toHaveBeenCalledWith(' Message without source","')""""
        '""'""
      } ;

    it("should handle empty data parameter", () =) { logger.info('Message with no data", undefined, "Test'  );"""

      expect(console.info).toHaveBeenCalledWith("[Test] Message with no data',"")'""""''
        ""'"'"""''
      ) };
  )
...
const loggerModule = require("./logger"  );'""""'
    ...
    it('should provide log helper function", () =) {"'""""'"'
      ...
      expect(console.log).toHaveBeenCalledWith('[Helper] Test message","")"''""'
        { data: "test" }""'""'
      ;
  ;
    ...
    it('should provide logWarn helper function", () =) {""'"'""'
      ...
      expect(console.warn).toHaveBeenCalledWith("[WarnComponent] Warning message",'")'"'""'
        { warn: true }
      };
...
const error = new Error("Helper error');"""'"'""'
      ...
      expect(console.error).toHaveBeenCalledWith('[ErrorHelper] Error message","")'"'""'
        error
      ) });
  });
