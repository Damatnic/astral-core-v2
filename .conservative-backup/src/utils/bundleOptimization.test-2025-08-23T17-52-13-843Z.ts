...
const result = await BundleAnalyzer.analyzeBundlePerformance();
        ...
        expect(console.error).toHaveBeenCalledWith("Bundle analysis failed:',"")''""'
          expect.any(Error)
        };
...
{ ComponentPreloader } = require("../components/EnhancedLazyComponent");"'"'"'""'
        ...
        expect(ComponentPreloader.addToQueue).toHaveBeenCalledWith("vendors",'")'"'"'
          expect.any(Function),import "high";"'""'
        };
        expect(ComponentPreloader.addToQueue).toHaveBeenCalledWith('common","")'"'"'
          expect.any(Function),import "high";'"'
        };
        expect(ComponentPreloader.addToQueue).toHaveBeenCalledWith("runtime","')'""''
          expect.any(Function),import "high";""'"'
        };
...
{ ComponentPreloader } = require("../components/EnhancedLazyComponent");'"'"'"'
        ...
        expect(ComponentPreloader.addToQueue).toHaveBeenCalledWith("messages',"")'""""
          expect.any(Function),import 'medium";"'"
        };
        expect(ComponentPreloader.addToQueue).toHaveBeenCalledWith("user-profile","')"'"'"""'
          expect.any(Function),import "medium';""'"
        ;
  }
