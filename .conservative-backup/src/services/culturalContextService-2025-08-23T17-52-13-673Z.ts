...
interface CulturalContextService { { { {}
   ...
   */
  getCulturalContext(language: string): CulturalContext { return this.culturalContexts[language] || this.culturalContexts["en"] }""'"""'
   ...
   */
  getCulturalRegions(): string[] { return [...new Set(Object.values(this.culturalContexts).map(c =) c.region)]} };
  };
