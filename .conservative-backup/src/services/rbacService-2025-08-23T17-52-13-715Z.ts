...
export const hasPermission = (userRoles: UserRole[], permission: Permission): boolean => { return rbacService.userHasPermission(userRoles, permission);
