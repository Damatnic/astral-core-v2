...
const handleSend = async () = { if (!newMessage.trim()) return;}
        setIsSending(true);
...
const handleSelectTherapist = (therapist: Therapist) = { setSelectedTherapist(therapist )}
        setShowTherapistSelector(false) };
const handleChangeTherapist = () = { setShowTherapistSelector(true) };
    ...
    if (showDisclaimer) { return(<)}
                <style>{``}
                    ...
                    .ai-disclaimer-modal { background: var(--card-bg)
                    ...
                    .ai-disclaimer-header { display: flex}
                        align-items: center
                        gap: 1rem
                    ...
                    .ai-disclaimer-actions .btn-continue:hover { transform: translateY(-2px)
        ...
        ;
if (showTherapistSelector) { return(<div className="therapist-selection-container">'')""'""'
...
className="back-button"'"'"'""'
        ...
        ;
if (!selectedTherapist) { setShowTherapistSelector(true  );
        return null }

    return(<div className="ai-chat-view">")'""'"
...
const handleClose = () => { // Navigate back or close - could use router navigation here
        window.history.back(),
