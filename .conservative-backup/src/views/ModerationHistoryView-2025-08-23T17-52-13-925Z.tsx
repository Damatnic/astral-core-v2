...
const actions = await ApiClient.moderation.getHistory(userId  );
  ...
  } catch (error) { console.error('Failed to fetch moderation history:", error  );"'""""
            // Provide sample data for demonstration
sampleHistory: ModerationAction[] = []
                {
                    id: 'mod-1","'""""
  ...
  ,
            ...
            setHistory(sampleHistory)  finally(setIsLoading(false) );
  , [userId]}

    useEffect(() =) { fetchHistory() }, [fetchHistory];

    return(<div className="moderation-history-container">"}'')""'"'
