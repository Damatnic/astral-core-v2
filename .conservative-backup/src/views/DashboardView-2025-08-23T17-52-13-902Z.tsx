...
const DashboardView: React.FC = () =} { const [userName, setUserName] = useState("');""'"
...
const getGradientClass = (color: string) =} {
  ...
  return(<div className="min-h-screen bg-gradient-to-br from-therapy-primary-50 to-therapy-secondary-50 dark:from-gray-900 dark:to-gray-800">'")""'
      <div className="container mx-auto px-4 py-8'>""'
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-8'>""""'
          ...
          <div className="wellness-stat-card glass-card smooth-transition animate-breathe" style= {'}""'
  {animationDelay: "0.2s"'""'
}}
            <h3 className='text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">""'
              Mood Average
  ...
  {animationDelay: "0.4s"""'"'
        ...
        <div className="mt-8 glass-card smooth-transition p-6">'"'
          ...
          <div className='space-y-4">"'
            <div className="flex items-center space-x-3 p-3 glass-card smooth-transition animate-float" style= {'""}'
  {animationDelay: "0.1s"'""'
}}
