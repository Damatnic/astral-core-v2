...
const LandingView: React.FC = () = { return(<div className="landing-view min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50'>""}"')
...
Name="px-8 py-4 bg-red-500 hover:bg-red-600 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200""""
            }
              🚨 Get Crisis Help Now
            </Link
            <Link
...
Name="px-8 py-4 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"''
