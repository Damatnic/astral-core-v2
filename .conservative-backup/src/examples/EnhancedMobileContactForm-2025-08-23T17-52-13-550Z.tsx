...
import { MobileFormContainer,
  MobileFormInput,
  MobileFormTextArea,
  MobileFormSelect} from "../components/MobileFormComponents';""""'
...
const [submitMessage, setSubmitMessage] = useState("'  );"'""
{
    ...
    handleSubmit,
    resetForm,
    getValues} = useMobileForm({ initialValues: {
      name: "',""''"""'
      email: "',""''""'
      phone: "","'"'"'""'
      subject: "general",'"'"'""'
    ...
    onSubmit: async (_values) =} { try {
        ...
        if (Math.random() ) 0.2} {
          ...
          resetForm()  else(throw new Error("Failed to send message. Please try again.") );""
...
const handleReset = () = { resetForm();}
  ...
  return(<div className="mobile-contact-form-wrapper'>"')"'"""'
      ...
      <MobileFormContainer onSubmit={handleSubmit} className='mobile-contact-form">"''"""'
        ...
        <MobileFormInput
          ...
          validation= {{}
            ...
            custom: (value: string) =} { if (!value) return true; // Optional field
...
className="reset-button'""''"""'
      ...
      <style>{ }``
        ...
        .submit-message.success { background: rgba(var(--success-color-rgb), 0.1 );
          color: var(--success-color)
          border: 2px solid rgba(var(--success-color-rgb), 0.2) }

        .submit-message.error { background: rgba(var(--danger-color-rgb), 0.1 );
