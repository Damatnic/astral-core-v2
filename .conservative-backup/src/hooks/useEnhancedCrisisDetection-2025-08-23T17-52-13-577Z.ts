...
severity: CrisisAlert["severity"] = "none"'"'
    ...
    if (riskLevel )= 90} { severity = "immediate' } else if (riskLevel )= 80 { severity = "critical" } else if (riskLevel )= 60 { severity = "high" } else if (riskLevel )}40}{severity = 'medium" } else if (riskLevel )=20) sverity = "low' }"""
